...
| `kafka` | `data-kafka-controller-0` | 8Gi | Acceptable loss. Transient event log — every consumer materializes into Postgres or another durable store downstream; nothing here is the last copy of anything. |
